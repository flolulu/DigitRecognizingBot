...
model.compile(loss=keras.losses.categorical_crossentropy, optimizer=keras.optimizers.Adadelta(), met['accuracy'])


# train the model by using model.fit() function
# this function takes the training data, validation data, epochs and batch size
# epochs refers to one cycle through the full training dataset. Usually takes a few
